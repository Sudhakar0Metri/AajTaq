 ...
 * @version 9.37(417)
 */
public class TC_AT_Feedback_007 extends Aajtak_app_Util{
	@Test(description="Verify that user is able to 'Submit' the 'Feedback' form by providing invalid phone number")
	public void AT_Feedback_007() throws InterruptedException
	{
		...
		//Fill invalid input of phone number and click on submit
		submitFeedback("Tester", "tester.ty@gamil.com", "Test", "This is a test comment");
		
		//It will verify that warning message is present or not
		isElementExist(feedBack.getWarrningMessageInPhoneNum());
	}
}
