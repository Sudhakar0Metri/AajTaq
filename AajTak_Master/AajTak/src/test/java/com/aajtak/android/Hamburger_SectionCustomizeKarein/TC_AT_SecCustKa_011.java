 ...
 * Description : Verify that user is able to uncheck 'Khel' option in 'Section Customize Kare'
 */

@Listeners(com.aajtak.android.listener.MyExtentListners.class)
public class TC_AT_SecCustKa_011 extends Aajtak_app_Util{

	@Test(description = "Description: Verify that user is able to uncheck 'Khel' option in 'Section Customize Kare'",priority = 9)
	public void AT_SecCustKa_011() throws InterruptedException
	{
		//Launching the app
		launchApp();
		...
		//Clicking on check box for khel opttion
		clickBtn(sectionCustomizeKaren.getSelectKhel(), "Check Box");

		//cliking on save kare option
