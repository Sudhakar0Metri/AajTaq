 ...
 * Description :  Verify that if user can select only 3G/4G
 */

@Listeners(com.aajtak.android.listener.MyExtentListners.class)
public class TC_AT_ImgDownload_004 extends Aajtak_app_Util{
	
	@Test(description="Description: Verify that if user can select only 3G/4G",priority = 5)
	public void AT_ImgDwnload_004()  throws InterruptedException 
	{
