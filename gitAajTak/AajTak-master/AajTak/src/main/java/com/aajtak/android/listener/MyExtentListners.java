...
package com.aajtak.android.listener;
...
import com.aajtak.android.library.GenericLib;
...
//			className = className.substring(className.lastIndexOf(".") + 1, className.length());
	...
	public void onStart(ITestContext context) {
		...
		sExcelPath = excelDir;
		screenShotPath = GenericLib.sDirPath + "/reports" + "/Run-" + sDate + "/extent/screenshots/";
...
//		sparkReport = new ExtentHtmlReporter(file1);
...
//		sparkReport.config().setDocumentTitle("Aajtak Automation");
//		sparkReport.config().setReportName("Aajtak Automation Report");
