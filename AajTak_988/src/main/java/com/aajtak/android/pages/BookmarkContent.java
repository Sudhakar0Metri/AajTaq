...
public class BookmarkContent {
	...
	private AndroidElement BookmarkFirstStory;
	...
	private AndroidElement VerifyFirstStoryTitle;
	...
	public AndroidElement getBookmarkFirstStory() {
		return BookmarkFirstStory;
	}


	public AndroidElement getVerifyFirstStoryTitle() {
		return VerifyFirstStoryTitle;
	}
