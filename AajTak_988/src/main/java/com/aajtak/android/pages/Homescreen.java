...
public class Homescreen {
	...
	private AndroidElement aajTakHomeLogocopy;
	...
	private AndroidElement SignInOrLogin;
	...
	private AndroidElement Superfasttitle;
	...
	@AndroidFindBy(xpath="((//android.view.ViewGroup[@resource-id='in.AajTak.headlines:id/clNewsStory'])//android.widget.TextView[@resource-id='in.AajTak.headlines:id/tvVideoOrPhoto'])[1]")
	...
	private AndroidElement PhotoGallery;
	
	@AndroidFindBy(xpath="(//android.widget.ImageView[@content-desc=\"News Image\"])[1]")
	private AndroidElement PhotoImg;
	
	@AndroidFindBy(id="in.AajTak.headlines:id/tvSeeMore")
	private AndroidElement aurbhi;
	
	@AndroidFindBy(xpath="//android.widget.ImageView[@content-desc=\"article\"]")
	...
	public AndroidElement getAajTakHomeLogocopy() {
		return aajTakHomeLogocopy;
	}

	@AndroidFindBy(xpath = "(//android.widget.TextView[@text='होम'])[1]")
	private AndroidElement HomeTab;
	
	@AndroidFindBy(xpath = "(//android.widget.TextView[@text='होम'])[2]")
	...
	public AndroidElement getSignInOrLogin() {
	...
	private AndroidElement badikhabreinSectionCopy;
	
	
	@AndroidFindBy(id="in.AajTak.headlines:id/moreOptions")
	private AndroidElement moreOPtions;
	
	@AndroidFindBy(id="in.AajTak.headlines:id/tvBottomBookmark")
	private AndroidElement bookmark_9_88;
	...
	private AndroidElement ShareOnlyonecard; 
	
	@AndroidFindBy(id="in.AajTak.headlines:id/tv_share_all_cards")
	private AndroidElement Shareallcard; 
	
	@AndroidFindBy(id="in.AajTak.headlines:id/shareLayout")
	private AndroidElement sharebadiKhabre;
	
	
	
	@AndroidFindBy(xpath="//android.widget.ImageView[@content-desc=\"Close\"]")
	private AndroidElement CancelStoryShare; 
	
	
	
	public AndroidElement getCancelStoryShare() {
		return CancelStoryShare;
	}

	public AndroidElement getShareallcard() {
		return Shareallcard;
	}

	@AndroidFindBy(id="in.AajTak.headlines:id/moreOptions")
	private AndroidElement AntButton;
	...
	@AndroidFindBy(id="in.AajTak.headlines:id/tvPhotoTitle")
	private AndroidElement photostory;
	...
	public AndroidElement getSuperfasttitle() {
		return Superfasttitle;
	}
	...
	public AndroidElement getBadikhabreinSectionCopy() {
		return badikhabreinSectionCopy;
	}
	...
	public AndroidElement getSharebadiKhabre() {
		return sharebadiKhabre;
	}

	public AndroidElement getShareOnlyonecard() {
		return ShareOnlyonecard;
	}
	...
	public AndroidElement getPhotoImg() {
		return PhotoImg;
	}

	public AndroidElement getHamburgerIconCopy() {
		return hamburgerIconCopy;
	}
	...
	public AndroidElement getHomebar() {
		return Homebar;
	}

	public AndroidElement getAntButton() {
		return AntButton;
	}
	...
	public AndroidElement getPhotostory() {
		return photostory;
	}

	public AndroidElement getPhoto() {
		return photo;
	}

	public AndroidElement getAurbhi() {
		return aurbhi;
	}
	...
	public AndroidElement getBookmark_9_88() {
		return bookmark_9_88;
	}
	...
	public AndroidElement getPhotoGallery() {
		return PhotoGallery;
	}
	...
	public AndroidElement getSuperfastShareIcon() {
		return SuperfastShareIcon;
	}
