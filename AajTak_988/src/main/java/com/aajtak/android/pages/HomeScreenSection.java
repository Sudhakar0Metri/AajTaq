...
public class HomeScreenSection {
	...
	@AndroidFindBy(xpath="//android.widget.TextView[@text='दिल्ली' and @resource-id='in.AajTak.headlines:id/tvCategory']")
	private AndroidElement delhibutton;
	...
	public AndroidElement getDelhibutton() {
		return delhibutton;
	}

	public AndroidElement getOtherStoriesfromBharathSection() {
		return otherStoriesfromBharathSection;
	}
	...
	public AndroidElement getSectionLabel() {
		return sectionLabel;
	}
