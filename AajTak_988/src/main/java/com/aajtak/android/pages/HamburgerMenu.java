...
public static AndroidDriver<AndroidElement> aDriver;
	...
	@AndroidFindBy(xpath="//android.widget.TextView[@resource-id='android:id/text1' and @text='वीडियो']")
	...
	private AndroidElement SettingsButtoncopy;
	...
	public AndroidElement getSettingsButtoncopy() {
		return SettingsButtoncopy;
	}
