...
public class NotificatonPayeOnboarding {
	...
	private AndroidElement notificationButtonCopy;
	...
	public AndroidElement getAageBadeTxt() {
		return aageBadeTxt;
	}
	public AndroidElement getNotificationButtonCopy() {
		return notificationButtonCopy;
	}
