...
public class TC_AT_NewsList_015 extends Aajtak_app_Util {
	@Test(priority = 23, description = "Description: Verify that once user swipes the Newslist screen from top to bottom on home screen, Newslist screen gets refreshed")
	...
	//	clickBtn(homescreen.getManoranjanTab());
		...
		waitTillElementPresent(homescreen.getFirstNewstitle(), 5);
