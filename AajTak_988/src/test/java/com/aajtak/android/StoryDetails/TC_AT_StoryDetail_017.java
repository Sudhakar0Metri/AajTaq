...
public class TC_AT_StoryDetail_017 extends Aajtak_app_Util {
	...
	@Test(priority = 33,description = "Description : Verify that the user is able to swipe through the Article")
	...
	//	Aajtak_app_Util.compelteOnboarding();
		...
		//waitTillElementPresent(storyDetail.getTitleOfAnyStory(),12);
