...
public class TC_AT_StoryDetail_001 extends Aajtak_app_Util {
	...
	@Test(priority = 24, description = "Description : Verify that user is navigate to the story detail screen when user taps on a story")
	...
	//	String actualTitle = homescreen.getFirstStoryTitle().getText();
		...
		isElementExist(homescreen.getBadiKahbreinSection(),"is verified");
	}
}
