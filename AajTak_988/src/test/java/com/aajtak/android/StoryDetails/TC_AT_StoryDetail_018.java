...
public class TC_AT_StoryDetail_018 extends Aajtak_app_Util {
	...
	@Test(priority = 1,description = "Verify that the user is able to play the embedded videos in the story detail screen")
	public void AT_StoryDetail_018() throws InterruptedException, IOException {
		...
		clickBtn(homescreen.getFirstNews());
		...
		isElementExist(storyDetail.getEmbeddedVideo(),"Embedded video");
