...
public class TC_AT_HomeSec_005 extends Aajtak_app_Util{
	...
	public void AT_HomeSec_005() throws InterruptedException {
		...
		//clickBtn(homescreen.getHomebar());
		swipeToElement(homescreen.getPhotoCategory());
	
		//scrollToElement(homescreen.getPhotoGallery());
		//Verifying gallery is present in home screen
		isElementExist(homescreen.getPhotoGallery(),"photo Gallery");
		...
		//clickBtn(homescreen.getPhotoGallery(),"photo Gallery");
		clickBtn(homescreen.getPhotoGallery(),"photo Gallery");
		scrollToElement(homescreen.getPhotoImg());
		clickBtn(homescreen.getPhotoImg());
