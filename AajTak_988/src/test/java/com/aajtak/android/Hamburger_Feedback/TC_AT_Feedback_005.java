 ...
 * @version 9.37(417)
 */
public class TC_AT_Feedback_005 extends Aajtak_app_Util{
	@Test(description="Verify that user is able to 'Submit' the 'Feedback' form by providing invalid name ")
	public void AT_Feedback_005() throws InterruptedException
	{
		...
		//Fill invalid input of name and click on submit
		submitFeedback("12@", "tester.ty@gamil.com", "7483025620", "This is a test comment");
		
		//It will verify that warning message is present or not
		isElementExist(feedBack.getWarrningMessageInName());
	}
}
